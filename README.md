...
The implementation uses Cox, DDPM MSE, and stop-gradient consistency losses. Ranking loss and Min-SNR reweighting are not used.
...
The program runs two source-cohort settings sequentially:
...
Inspect or override any default with:
...
- Reported bootstrap confidence intervals are not generated by this training entry point.

## Citation

Please cite this work if you use this repository. Replace the placeholder publication fields below when the final MICCAI bibliographic record is available.
